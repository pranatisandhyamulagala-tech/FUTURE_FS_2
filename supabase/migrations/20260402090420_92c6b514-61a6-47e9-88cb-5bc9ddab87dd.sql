...
-- RLS policies for leads: only authenticated admins can CRUD
...
-- Allow admins to read their own roles
...
-- Function to auto-assign admin role on signup (first user gets admin)
